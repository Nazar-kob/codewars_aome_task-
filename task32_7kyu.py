...
# would be aaabbbbhaijjjm meaning that the printer used
...
# a string will return the error rate of the printer
# as a string representing a rational whose numerator
# is the number of errors and the denominator the length
